            ...
            header={
                    ...
                    <div className="">
                            ...
                            <div className="container">
                              <div className="row pospago-contains">
                                 ...
                                 */}
                                  ...
                                  <div className="col-lg-4 col-md-4  col-sm-12 col-12 col-precios">
                                    <div className="inalambrico-container">
                                      <div className="blue-container-planpostpago">
                                        ...
                                        <div className="precio-container">
                                          ...
                                          <p className="pospago-precio-text">249</p>
                                        </div>
                                  ...
                                  <div className="col-lg-4 col-md-4  col-sm-12 col-12 col-precios">
                                    <div className="inalambrico-container">
                                      <div className="blue-container-planpostpago">
                                        ...
                                        <div className="precio-container">
                                          <p className="money-text">$</p>
                                          <p className="pospago-precio-text">399</p>
                                        </div>
                                        <p className="pospago-month-text">Al mes</p>
                                        <a href="/cobertura_inalambrico" className="btn pospago-btn-contratar">Cobertura</a>
                                      </div>
                          ...
                          <div className="col-12  small-inalam pospago-contains legales">
                           <p>El pago de los gastos de activación a 3 meses sin intereses aplica con Tarjeta de Crédito HSBC y BBVA. Todos los paquetes están sujetos a condiciones técnicas y disponibilidad de cobertura. *Precios señalados son de carácter informativo, en moneda nacional e impuestos incluidos del 16%, sujetos a cambio previa autorización de la Autoridad competente. Si quieres conocer más consulta términos y condiciones en oninternet.com.mx. La información aquí presentada (imágenes, textos, logos y cualquier elemento), constituye derechos de autor y propiedad intelectual usada con autorización de su titular, protegidos por las leyes aplicables. Vigencia válida al 30 de septiembre de 2021.</p>
                            <div className="col-12  small-inalam  legales">
