                    ...
                    <div className="carousel-inner bg-primary text-light" role="listbox">
                        <div className="row">
                         ...
                         {/*<div className="carousel-item active">
                                <a href="https://oninternet.com.mx/On%20Internet/Amazon%20Prime">  <div className="row bannericon_1"></div></a>
                                
                          </div>*/ } 

                         {/*<div className="carousel-item">
                                <a href="#SitioOn-amazon" ><div className="row banner_desktop"></div></a>
                          </div>*/} 
