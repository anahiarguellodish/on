      ...
      header={
        ...
        <div className="">
          <div className="">
            ...
            <div className="container">
              <div className="row pospago-contains">
                  ...
                  <div className="inalambrico-container">
                    <div className="blue-container-planpostpago">
                      <div className="icon-text mb-3">
                        ...
                        <p className="oninalam-text">ON INAL&Aacute;MBRICO</p>
                      ...
                      <div className="precio-container">
                        ...
                        <p className="amazon-precio-text">341</p>
                        <p className="amazon-month-text">Al mes</p>
                      </div>
                      <p className="amazon-impuestos">Impuestos incluidos</p>
                      <a href="/contrata" className="btn pospago-btn-contratar">Contratar</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="inalambrico-container">
                    <div className="blue-container-planpostpago">
                      ...
                      <ul class="check-it col-12">
                        ...
                        <div className="precio-container">
                          <p className="amazon-money-text">$</p>
                          <p className="amazon-precio-text">525</p>
                          <p className="amazon-month-text">Al mes</p>
                        </div>
                          <p className="amazon-impuestos">Impuestos incluidos</p>
                          <a href="/contrata" className="btn pospago-btn-contratar">Contratar</a>
                ...
                <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                <div className="yellow-container-amaz container-amaz-masVelocidad">
                  ...
                  <div className="inalambrico-container">
                    <div className="blue-container-planpostpago">
                      ...
                      <ul class="check-it col-12">
                        ...
                        <div className="precio-container">  
                          <p className="amazon-money-text">$</p>
                          <p className="amazon-precio-text">715</p>
                          <p className="amazon-month-text">Al mes</p>
                        </div>
                          <p className="amazon-impuestos">Impuestos incluidos</p>
                          <a href="/contrata" className="btn pospago-btn-contratar">Contratar</a>
                ...
                <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                  <div className="inalambrico-container">
                    <div className="blue-container-planpostpago">
                      ...
                      <div className="precio-container">
                        <p className="amazon-money-text">$</p>
                        <p className="amazon-precio-text">825</p>
                        <p className="amazon-month-text">Al mes</p>
                      </div>
                      <p className="amazon-impuestos">Impuestos incluidos</p>
                      <a href="/contrata" className="btn pospago-btn-contratar">Contratar</a>
          ...
          <div className="container prepago-contains">
            ...
            <p className="mt-4 prepago_tc fronterizo_3">Los servicios están sujetos a disponibilidad de cobertura, condiciones, facilidades técnicas y diversos factores externos del servicio. Vigencia al 30 de septiembre de 2021 o hasta agotar existencias. Sujetos a cambio con previa autorización de la Autoridad competente.</p>
