...
import amazon_logo from '../media/img_on_amazon/Grupo 3807.svg';
import Wifi_OnAmazon from '../media/img_on_amazon/Grupo 4876.svg';
import check from '../media/img_on_amazon/Trazado 6672.svg';
...
class PreciosFronterizos extends React.Component {
  ...
  componentDidMount() {
    ...
    $(document).ready(function () {
      ...
      $(".suscribe-amazon").addClass("suscribe-inactive");
      $(".inalambrico-contains").show();
      $(".alambrico-contains").hide();
      $(".satelital-contains").hide();
      $(".amazon-contains").hide();
      ...
      $("#suscribe-amazon").click(function () {
        $(".amazon-contains").show();
        $(".alambrico-contains").hide();
        $(".inalambrico-contains").hide();
        $(".satelital-contains").hide();
        $(".suscribe-amazon").addClass("suscribe-active");
        $(".suscribe-amazon").removeClass("suscribe-inactive");
        $(".suscribe-alambrico").addClass("suscribe-inactive");
        $(".suscribe-inalambrico").addClass("suscribe-inactive");
        $(".suscribe-satelital").addClass("suscribe-inactive");
  ...
  render() {
    return (
      <div className="">
        <div className="col-12 title-top d-flex justify-content-center">
          <div className="col-md-8">
            <small className=""><strong>ON Internet</strong>, en cumplimiento con el Decreto de <strong> estímulos fiscales región fronteriza norte</strong>, aplicará el respectivo porcentaje en los impuestos a nuestros servicios en dicha región.</small>
          </div>
          <div className="flecha-down_fronterizo"></div>
        </div>
        ...
        <div className="accordion" id="accordionprecios">
          <div className="card">
            <div className="card-header precios-frontera" id="headingOne">
              <h2 className="mb-0">
                <button className="btn btn-link" type="button" data-toggle="collapse" data-target="#precios" aria-expanded="true" aria-controls="precios">
                  VER PRECIOS FRONTERIZOS <i className="ml-3 fas fa-chevron-down"></i>
                </button>
              </h2>


              <div id="precios" className="collapse show col-12 mt-2" aria-labelledby="headingOne" data-parent="#accordionprecios">
                <div className="card-body container">

                  <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-12 ">
                      <div className="tabs-container d-flex justify-content-center">
                        <div className="suscribe-inalambrico" id="suscribe-inalambrico">
                          <p className="suscribe-text">ON INALÁMBRICO</p>
                        </div>
                        <div className="suscribe-alambrico ml-2" id="suscribe-alambrico">
                          <p className="suscribe-text">ON ALÁMBRICO</p>
                        </div>
                        <div className="suscribe-satelital ml-2" id="suscribe-satelital">
                          <p className="suscribe-text">ON SATELITAL</p>
                        </div>
                        <div className="suscribe-amazon ml-2" id="suscribe-amazon">
                          <p className="suscribe-text">ON INTERNET / AMAZON PRIME</p>
                        </div>
                      </div>
                    </div>
                  </div>

                  <div className="row inalambrico-contains">
                    <div className="">
                      <div className="">
                          ...
                          <div className="row pospago-contains">
                            ...
                            <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                              <div className="inalambrico-container">
                                <div className="blue-C-PFInalam-Postpago">
                                  ...
                                  <p className="pospago-capacidad-text-PF">5</p>
                                  ...
                                  <div className="precio-container">
                                    ...
                                    <p className="pospago-precio-text">255</p>
                                  </div>
                                  <p className="pospago-month-text">Al mes</p>
                                  <a href="/cobertura_inalambrico" className="btn pospago-btn-contratar">Contratar</a>
                                </div>
                              </div>
                            </div>
                            <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                              <div className="inalambrico-container">
                                <div className="blue-C-PFInalam-Postpago">
                                  ...
                                  <div className="divider-alt"></div>
                                  <p className="pospago-hasta-inalam"></p>
                                  <p className="pospago-capacidad-text-PF">10</p>
                                  <p className="megas-text"></p>
                                  {/*<!--<p className="velocidad-text"><span>DE</span> VELOCIDAD</p>-->*/}
                                  <div className="pospago-yellow-container-inalam">
                                    <div className="icon-text">
                                  ...
                                  <div className="precio-container">
                                    <p className="money-text">$</p>
                                    <p className="pospago-precio-text">419</p>
                                  </div>
                                  <p className="pospago-month-text">Al mes</p>
                                  <a href="/cobertura_inalambrico" className="btn pospago-btn-contratar">Contratar</a>
                                </div>
                            ...
                            <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                            <div className="yellow-container-front container-front-masVelocidad">
                              ...
                              <div className="inalambrico-container">
                                <div className="blue-C-PFInalam-Postpago">
                                  ...
                                  <div className="precio-container">
                                    <p className="money-text">$</p>
                                    <p className="pospago-precio-text">604</p>
                                  </div>
                                  <p className="pospago-month-text">Al mes</p>
                                  <a href="/cobertura_inalambrico" className="btn pospago-btn-contratar">Contratar</a>
                                </div>
                            ...
                            <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                              <div className="inalambrico-container">
                                <div className="blue-C-PFInalam-Postpago">
                                  ...
                                  <div className="divider-alt"></div>
                                  <p className="pospago-hasta-inalam"></p>
                                  <p className="pospago-capacidad-text-PF">20</p>
                                  <p className="megas-text"></p>
                                  {/*<!--<p className="velocidad-text"><span>DE</span> VELOCIDAD</p>-->*/}
                                  <div className="pospago-yellow-container-inalam">
                                    <div className="icon-text">
                                  ...
                                  <div className="precio-container">
                                    <p className="money-text">$</p>
                                    <p className="pospago-precio-text">714</p>
                                  </div>
                                  <p className="pospago-month-text">Al mes</p>
                                  <a href="/cobertura_inalambrico" className="btn pospago-btn-contratar">Contratar</a>
                                </div>
                                ...
                                <div className="col-md-9 col-sm-12 col-12 grey-card">
                                  <div className="card-body prepago-card-info row">
                                    ...
                                    <div className="prepago-btn-contratar col-md-4 col-sm-12 col-12">
                                      <a href="/cobertura_inalambrico"><button class="btn prepago-btn btn-lg col-12" type="button"> ¡LA QUIERO!</button></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="container prepago-contains">
                        ...
                        <p className="mt-4 prepago_tc fronterizo_3">Los servicios están sujetos a disponibilidad de cobertura, condiciones, facilidades técnicas y diversos factores externos del servicio. Vigencia al 31 de marzo de 2021 o hasta agotar existencias. Sujetos a cambio con previa autorización de la Autoridad competente.</p>
                      ...
                      <div className="col-12  small-inalam pospago-contains legales">
                        <p> Todos los paquetes están sujetos a condiciones técnicas y disponibilidad de cobertura. *Precios señalados son de carácter informativo, en moneda nacional e impuestos incluidos del 8%, sujetos a cambio previa autorización de la Autoridad competente. Si quieres conocer más consulta términos y condiciones en oninternet.com.mx. La información aquí presentada (imágenes, textos, logos y cualquier elemento), constituye derechos de autor y propiedad intelectual usada con autorización de su titular, protegidos por las leyes aplicables. Vigencia válida al  28 de febrero de 2022.</p>

                        <small><br />Consulta  tarifas registradas  ante  IFT <a href="https://oninternet.com.mx/ratesin">aquí</a></small><br />
                      </div>
                    ...
                    <div className="container">
                      ...
                      <div className="row internet-contains">
                        <div className="col-lg-3 col-md-6  col-sm-12 col-12 col-precios">
                          ...
                          <div className="yellow-container-alam container-alam-masVelocidad-PF">

                            <div className="row">
                              <p className="col-md-12 col-sm-12 col-lg-12 recibeMas-PF">RECIBE MAYOR VELOCIDAD</p>
                            </div>

                            <div className="row segundo_texto-PF">
                              <p className="primeros-PF col-md-12 col-sm-12 col-lg-12">Los primeros</p>
                              <p className="masVelocidadMonths-PF col-md-12 col-sm-12 col-lg-12"> 3 MESES</p>
                            </div>

                          </div>

                          <div className="inalambrico-container">
                            <div className="blue-masVelocidad-PF-internet">
                              <div className="icon-text">
                                <p className="hasta-text-masVelocidad-PF vel-alam">Internet</p>
                                {/*<img className="img-vel" src={velocidad}/>*/}
                              </div>
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text-masVelocidad-PF cap-alam">20</p>
                              <p className="megas-text megas-alam"></p>

                              <div className="yellow-container-alam-internet-PF precio-container">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">325</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6  col-sm-12 col-12 col-precios">
                          ...
                          <div className="inalambrico-container">
                            <div className="blue-masVelocidad-PF-internet">
                              ...
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text-masVelocidad-PF cap-alam">30</p>
                              <p className="megas-text megas-alam"></p>

                              <div className="yellow-container-alam-internet-PF precio-container">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">371</p>
                                </div>
                                <p className="month-text-alam ">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                        ...
                        <div className="col-lg-3 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-C-PF-internet">
                              <div className="icon-text">
                              ...
                              <div className="yellow-container-alam-internet-PF precio-container container-alam-PF-net">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">519</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                          ...
                          <div className="inalambrico-container">
                            <div className="blue-C-PF-internet">
                              ...
                              <div className="yellow-container-alam-internet-PF precio-container container-alam-PF-net">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">837</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                        ...
                        <div className="col-12 btn-lg small-alam legales">
                          <small className="tel-contains">*Tu servicio incluye llamadas ilimitadas a números fijos y móviles en México, Estados Unidos, Canadá y hasta 180 países más, consulta lista de destinos completa según tu servicio adquirido <a href={destinos} target="_blank">aquí</a>.  Precios con impuestos incluidos. Términos y Condiciones <a href={tcon} target="_blank">aquí</a>. </small>
                          <br />
                          <small><strong>COBERTURA A NIVEL NACIONAL</strong></small><br />
                          <small>*El beneficio de diferirlo hasta en cuatro meses, aplica para clientes que mantengan su pago mensual al corriente. Precios señalados son de carácter informativo, en moneda nacional e impuestos incluidos del 8%, sujeto a cambio previa autorización de la Autoridad competente. Para asistencia en la contratación de servicios, formas de pago, términos, condiciones, costos, características, paquetes, así como los beneficios de navegar a mayor velocidad por tres meses (aplica para nuevas contrataciones de paquetes ON Alámbrico y que se mantengan al corriente en el pago de su servicio) llame al 5555 123 123 o en www.oninternet.com.mx. Los servicios están sujetos a disponibilidad de cobertura y facilidades técnicas. Derechos reservados de Comercializadora de Frecuencias Satelitales S. de R.L. de C.V. Todo material aquí referido constituye derechos de autor y propiedad intelectual usada bajo autorización, protegidos por leyes mexicanas e internacionales. Vigencia de la promoción al  28 de febrero de 2022.</small>
                      ...
                      <div className="row tel-contains suscribe-inactivo telconteins_fronterizo">

                        <div className="col-lg-2 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container-PF-telfija">
                            <div className="blue-container-PF-telfija">
                              <div className="icon-text">
                                <p className="hasta-text">Internet</p>
                                {/*<img src={max_speed}/>*/}
                              </div>
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text cap-tel cap-tel_fronterizos">20</p>
                              <p className="megas-text megas-tel"></p>
                              <p className="linea-text linea_fronterizos"><img className="mr-2" src={mas} />1 línea con llamadas ilimitadas*</p>


                              <div className="yellow-container-alam precio-container container-alam-PF-telfija cont-tel_home cont-tel">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">365</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container-PF-telfija">
                            <div className="blue-container-PF-telfija">
                              ...
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text cap-tel cap-tel_fronterizos">30</p>
                              <p className="megas-text megas-tel"></p>
                              <p className="linea-text linea_fronterizos"><img className="mr-2" src={mas} />1 línea con llamadas ilimitadas*</p>
                              ...
                              <div className="yellow-container-alam precio-container container-alam-PF-telfija cont-tel_home cont-tel">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">405</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <div className="old-capacidad-tel">
                                <span>LOS PRIMEROS 3 MESES <br /> <strong className="ofertON">PAGAS $365</strong> </span>
                              </div>
                              <div className="arrow-linea"></div>
                              <div className="arrow-r-linea arrow-l-PF-nettel"></div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam btn-special">Contratar</a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container-PF-telfija">
                            <div className="blue-container-PF-telfija">
                              ...
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text cap-tel cap-tel_fronterizos">40</p>
                              <p className="megas-text megas-tel"></p>
                              <p className="linea-text linea_fronterizos"><img className="mr-2" src={mas} />1 línea con llamadas ilimitadas*</p>
                              ...
                              <div className="yellow-container-alam precio-container container-alam-PF-telfija cont-tel_home cont-tel">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">465</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <div className="old-capacidad-tel">
                                <span>LOS PRIMEROS 3 MESES <br /> <strong className="ofertON">PAGAS $405</strong> </span>
                              </div>
                              <div className="arrow-linea"></div>
                              <div className="arrow-r-linea arrow-l-PF-nettel"></div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam btn-special">Contratar</a>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container-PF-telfija">
                            <div className="blue-container-PF-telfija">
                              ...
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text cap-tel cap-tel_fronterizos">150</p>
                              <p className="megas-text megas-tel"></p>
                              <p className="linea-text linea_fronterizos tamanio_letra_fronterizo"><img className="mr-2" src={mas} />Hasta 2 líneas con llamadas ilimitadas*</p>


                              <div className="yellow-container-alam precio-container container-alam-PF-telfija cont-tel_home cont-tel">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">559</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <div className="old-capacidad-tel">
                                <span>LOS PRIMEROS 3 MESES <br /> <strong className="ofertON">PAGAS $465</strong> </span>
                              </div>
                              <div className="arrow-linea"></div>
                              <div className="arrow-r-linea arrow-l-PF-nettel"></div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam btn-special">Contratar</a>
                        ...
                        <div className="col-lg-2 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container-PF-telfija">
                            <div className="blue-container-PF-telfija">
                              ...
                              <div className="divider-alt"></div>
                              <p className="hasta-alam"></p>
                              <p className="capacidad-text cap-tel cap-tel_fronterizos">200</p>
                              <p className="megas-text megas-tel"></p>
                              <p className="linea-text linea_fronterizos">Hasta 3 Líneas con llamadas ilimitadas*</p>


                              <div className="yellow-container-alam precio-container container-alam-PF-telfija cont-tel_home cont-tel">
                                <div className="row cont-precio">
                                  <p className="money-t-alam col-md-1 col-sm-4 col-2">$</p>
                                  <p className="precio-t-alam textocentrado col-md-5 col-sm-6 col-4 ml-n3">935</p>
                                </div>
                                <p className="month-text-alam">Al mes</p>
                              </div>
                              <a href="https://oninternet.com.mx/contrata" className="btn contrata-alam">Contratar</a>
                        ...
                        <div className="col-12 btn-lg small-alam legales">
                          <small className="tel-contains"> **El beneficio de diferirlo hasta en cuatro meses, aplica para clientes que mantengan su pago mensual al corriente. *Tu servicio incluye llamadas ilimitadas a números fijos y móviles en México, Estados Unidos, Canadá y hasta 180 países más, consulta lista de destinos completa según tu servicio adquirido <a href={destinos} target="_blank">aquí</a>.  Precios con impuestos incluidos. Términos y Condiciones <a href={tcon} target="_blank">aquí</a>. </small>
                          <br />
                          <small><strong>COBERTURA A NIVEL NACIONAL</strong></small><br />
                          <small>Los servicios están sujetos a disponibilidad de cobertura, condiciones, facilidades técnicas y diversos factores pueden afectar la velocidad de navegación del servicio. Vigencia al  28 de febrero de 2022 o hasta agotar existencias. Sujetos a cambio con previa autorización de la Autoridad competente.</small>
                  ...
                  <div className="row satelital-contains">
                    ...
                    <div className="container">
                        ...
                        <div className="col-lg-2 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container blue-bas">
                              ...
                              <div className="yellow-container y-cont-PF-bas">
                                <div className="icon-text">
                              ...
                              <div className="precio-container">
                                ...
                                <p className="precio-text precio-bas">725</p>
                              </div>
                              ...
                              <div className="arrow-left arrow-left-PFbas"></div>
                              <div className="arrow-right arrow-r-bas"></div>

                              <a href="/cobertura_satelital" className="btn btn-contratar contrata-sat">Contratar</a>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-2 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container blue-bas">
                              ...
                              <div className="precio-container">
                                <p className="money-text money-bas">$</p>
                                <p className="precio-text precio-bas">949</p>
                              </div>
                              <p className="month-text month-bas">Al mes</p>
                              <div className="capacidad-yellow cap-y-b caratula-sat">
                                <p>CAPACIDAD ORIGINAL</p>
                        ...
                        <div className="col-lg-2 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container blue-bas">
                              ...
                              <div className="precio-container">
                                <p className="money-text money-bas">$</p>
                                <p className="precio-text precio-bas">1,119</p>
                              </div>
                              <p className="month-text month-bas">Al mes</p>
                          ...
                          <div className="inalambrico-container">
                            ...
                            <div className="blue-container-alt blue-bas fronterizo_3">
                              ...
                              <div className="precio-container">
                                ...
                                <p className="precio-text-alt precio-bas">1,305</p>
                              </div>
                              ...
                              <div className="arrow-left arrow-left-PFbas arrow-bas"></div>
                              <div className="arrow-right arrow-r-bas"></div>
                              <a href="/cobertura_satelital" className="btn btn-contratar contrata-sat">Contratar</a>
                            </div>
                          </div>
                        ...
                        <div className="col-lg-2 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container blue-bas">
                              ...
                              <div className="precio-container">
                                <p className="money-text money-bas">$</p>
                                <p className="precio-text precio-bas">1,675</p>
                              </div>
                              <p className="month-text month-bas">Al mes</p>
                              <div className="capacidad-yellow cap-y-b">
                                <p>CAPACIDAD ORIGINAL</p>
                      ...
                      <div className="row extremo-contains suscribe-inactivo">
                        <div className="col-lg-3 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container-PF-ext">
                              <div className="icon-text">
                                <p className="hasta-text">Internet</p>
                                {/*<img src={max_speed}/>*/}
                              </div>
                              ...
                              <div className="yellow-container yellow-container-PF">
                                <div className="icon-text">
                                  <p className="capacidad-text-alt-alt">Capacidad por promoción</p>
                                  <img src={IconoPila} />
                                </div>
                              ...
                              <div className="precio-container">
                                <p className="money-text">$</p>
                                <p className="precio-text">2,047</p>
                              </div>
                              ...
                              <div className="arrow-right arrow-r-PFext"></div>
                              <div className="contratar-btn">
                                <a href="/cobertura_satelital" className="btn btn-contratar-alt">Contratar</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-3 col-md-6 col-sm-12 col-12 col-precios special-pack-alt">
                          <div className="inalambrico-container">
                            <div className="special-pack sp-ex-PF d-flex justify-content-center">
                              <h6 className="special-text">PAQUETE ESPECIAL</h6>
                              <div className="flecha-down-alt"></div>
                            </div>
                            <div className="blue-container-alt-PF">
                              <div className="icon-text">
                              ...
                              <div className="yellow-container-alt p-container p-container-ex-PF">
                                <div className="icon-text">
                                  <p className="capacidad-text-alt-alt cap-sat">Capacidad por promoción</p>
                                  <img src={Cap30Gb} />
                                </div>
                              ...
                              <div className="precio-container">
                                ...
                                <p className="precio-text-alt">1,305</p>
                              </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container-PF-ext">
                              ...
                              <div className="precio-container">
                                <p className="money-text">$</p>
                                <p className="precio-text">2,885</p>
                              </div>
                              <p className="month-text">Al mes</p>
                              <div className="capacidad-yellow">
                                <h6>CAPACIDAD ORIGINAL</h6>
                        ...
                        <div className="col-lg-3 col-md-6  col-sm-12 col-12 col-precios">
                          <div className="inalambrico-container">
                            <div className="blue-container-PF-ext">
                              ...
                              <div className="precio-container">
                                <p className="money-text">$</p>
                                <p className="precio-text">4,285</p>
                              </div>
                              <p className="month-text">Al mes</p>
                              <div className="capacidad-yellow">
                                <h6>CAPACIDAD ORIGINAL</h6>
                  ...
                  <div className="ml-2 mt-3 row amazon-contains">
                    <div className="row">
                      <div id="SitioOn-amazon" className="mt-1 mb-5 col-lg-12 col-md-12 col-12 t-container-amazon">
                        <h2 className="mt-1"><b>Elige tu paquete ON Internet con Amazon Prime Incluido</b></h2>
                      </div>
                        ...
                        <div className="inalambrico-container">
                          <div className="blue-container-planpostpago">
                            <div className="icon-text mb-3">
                              <img class="wifi-logo centered mx-2 mt-1 md-1" src={Wifi_OnAmazon} />
                              <p className="oninalam-text">ON INALÁMBRICO</p>
                              {/*<img src={tacometro_bajo}/>*/}
                            </div>
                            <div className="divider-alt"></div>
                            <p className="pospago-hasta-inalam"></p>
                            <p className="hasta-text-amazon">Internet</p>
                            <p className="amazon-capacidad-text">5</p>
                            <p className="megas-text-amazon"></p>
                            {/*<!--<p className="velocidad-text"><span>DE</span> VELOCIDAD</p>-->*/}
                            <div className="pospago-yellow-container-amazon">
                              <div className="mt-3 icon-text pila-box">
                                <p className="amazon-capacidad-text-alt">Capacidad</p>
                                <img src={Capacidad_baja} />
                              </div>
                              <div className="divider-amazon"></div>
                              <p className="gigas-text-amazon">80<span class="ml-2">GB</span></p>
                              <p className="caract-text-amazon">Ideal para conectar 2 dispositivos a la vez</p>
                            </div>
                            {/*<!--<p className="pospago-hasta-inalam mt-2">Desde</p>-->*/}
                            <p class="incluye centered mt-2 mb-1">Incluye</p>
                            <img class="amazon-brand centered mt-2 mb-4" src={amazon_logo} />
                            <ul class="check-it col-12">
                              <li class="centered precio-container">
                                <img src={check}/>
                                <p>Envíos gratis, video, música y juegos</p>
                              </li>
                              <li class="centered precio-container">
                                <img src={check} />
                                <p>Internet fácil que enchufas, enciendes y usas.</p>
                              </li>
                              <li class="centered precio-container">
                                <img src={check} />
                                <p>Muévelo en cualquier parte dentro de tu casa.</p>
                              </li>
                            </ul>
                            <div className="precio-container">
                              <p className="amazon-money-text">$</p>
                              <p className="amazon-precio-text">327</p>
                              <p className="amazon-month-text">Al mes</p>
                            </div>
                            <p className="amazon-impuestos">Impuestos incluidos</p>
                            <a href="https://oninternet.com.mx/contrata" className="btn pospago-btn-contratar">Contratar</a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                        <div className="inalambrico-container">
                          <div className="blue-container-planpostpago">
                            ...
                            <p className="pospago-hasta-inalam"></p>
                            <p className="hasta-text-amazon">Internet</p>
                            <p className="amazon-capacidad-text">10</p>
                            <p className="megas-text-amazon"></p>
                            {/*<!--<p className="velocidad-text"><span>DE</span> VELOCIDAD</p>-->*/}
                            <div className="pospago-yellow-container-amazon">
                              <div className="mt-3 icon-text pila-box">
                              ...
                              <div className="divider-amazon"></div>
                              <p className="gigas-text-amazon">120<span class="ml-2">GB</span></p>
                              <p className="caract-text-amazon">Ideal para conectar 3 dispositivos a la vez</p>
                            </div>
                            {/*<!--<p className="pospago-hasta-inalam mt-2">Desde</p>-->*/}
                            <p class="incluye centered mt-2 mb-1">Incluye</p>
                            <img class="amazon-brand centered mt-2 mb-4" src={amazon_logo} />
                            <ul class="check-it col-12">
                              <li class="precio-container">
                                <img src={check} />
                                <p>Envíos gratis, video, música y juegos</p>
                              </li>
                              <li class="precio-container">
                            ...
                            <div className="precio-container">
                              <p className="amazon-money-text">$</p>
                              <p className="amazon-precio-text">497</p>
                              <p className="amazon-month-text">Al mes</p>
                            </div>
                            <p className="amazon-impuestos">Impuestos incluidos</p>
                            <a href="https://oninternet.com.mx/contrata" className="btn pospago-btn-contratar">Contratar</a>
                      ...
                      <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                      <div className="yellow-container-frontamaz container-frontamaz-masVelocidad">
                        ...
                        <div className="inalambrico-container">
                          <div className="blue-container-planpostpago">
                            ...
                            <div className="pospago-yellow-container-amazon">
                              ...
                              <div className="divider-amazon"></div>
                              <p className="gigas-text-amazon">200<span class="ml-2">GB</span></p>
                              <p className="caract-text-amazon">Ideal para conectar 3 dispositivos a la vez</p>
                            </div>
                            {/*<!--<p className="pospago-hasta-inalam mt-2">Desde</p>-->*/}
                            <p class="incluye centered mt-2 mb-1">Incluye</p>
                            ...
                            <div className="precio-container">
                              <p className="amazon-money-text">$</p>
                              <p className="amazon-precio-text">673</p>
                              <p className="amazon-month-text">Al mes</p>
                            </div>
                            <p className="amazon-impuestos">Impuestos incluidos</p>
                            <a href="https://oninternet.com.mx/contrata" className="btn pospago-btn-contratar">Contratar</a>
                      ...
                      <div className="col-lg-3 col-md-4  col-sm-12 col-12 col-precios">
                        <div className="inalambrico-container">
                          <div className="blue-container-planpostpago">
                            ...
                            <p className="pospago-hasta-inalam"></p>
                            <p className="hasta-text-amazon">Internet</p>
                            <p className="amazon-capacidad-text">20</p>
                            <p className="megas-text-amazon"></p>
                            {/*<!--<p className="velocidad-text"><span>DE</span> VELOCIDAD</p>-->*/}
                            <div className="pospago-yellow-container-amazon">
                              <div className="mt-3 icon-text pila-box">
                              ...
                              <div className="divider-amazon"></div>
                              <p className="gigas-text-amazon">180<span class="ml-2">GB</span></p>
                              <p className="caract-text-amazon">Ideal para conectar 4 dispositivos a la vez</p>
                            </div>
                            {/*<!--<p className="pospago-hasta-inalam mt-2">Desde</p>-->*/}
                            <p class="incluye centered mt-2 mb-1">Incluye</p>
                            <img class="amazon-brand centered mt-2 mb-4" src={amazon_logo} />
                            ...
                            <div className="precio-container">
                              <p className="amazon-money-text">$</p>
                              <p className="amazon-precio-text">783</p>
                              <p className="amazon-month-text">Al mes</p>
                            </div>
                            <p className="amazon-impuestos">Impuestos incluidos</p>
                            <a href="https://oninternet.com.mx/contrata" className="btn pospago-btn-contratar">Contratar</a>
                  ...
                  <div className="container" id="bannerBack">
                    <div className="row">
                        ...
                        <div className="col-md-3 purple-square">
                            <center>
                  ...
                  <div className="centered mt-4">
                      ...
                      <div className="payment-text">
                          ...
                          <p> Todos los paquetes están sujetos a condiciones técnicas y disponibilidad de cobertura. Vigencia válida al  28 de febrero de 2022. Todos los paquetes están sujetos a condiciones técnicas y disponibilidad de cobertura. *Los Precios aquí señalados son de carácter informativo, en moneda nacional e impuestos incluidos del 8%. Precios sujetos a cambio con previa autorización de la Autoridad Competente. Para conocer más consulta términos y condiciones en oninternet.com.mx. La información presentada (imágenes, textos, logos y cualquier otro elemento) constituye derechos de autor y propiedad intelectual usada con autorización de su titular, protegidos por las leyes aplicables.</p>
                      </div>
                  </div>
...
export default PreciosFronterizos;
